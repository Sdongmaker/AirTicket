<%@ page language="java" import="indi.bean.UserInfo" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
...
<div class="container">
    ...
    <form class="form-signin" method="post" action="${pageContext.request.contextPath}/user?method=login">
        ...
        <button class="btn btn-lg btn-primary btn-success btn-block"
                type="button" onclick="javascript:window.location.href='register.jsp';">注册
        </button>
    </form>
